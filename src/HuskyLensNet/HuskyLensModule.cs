...
namespace HuskyLensNet
{
    ...
    public class HuskyLensModule
    {
        ...
        void init()
        {
            var i2cConnectionSettings = new I2cConnectionSettings(I2CBUS, I2CADDRESS);
            i2cDevice = I2cDevice.Create(i2cConnectionSettings);
        
        }
        public HuskyLensModule()
        {
            initI2c();
        }
        /**
        ...
        void DoTest()
        {
            ...
            while (true)
            {
                ...
                if (huskylens.isAppear_s(HUSKYLENSResultType_t.HUSKYLENSResultBlock))
                {
                    ...
                    {
                        Debug.WriteLine("x {0}", huskylens.readeBox(1, Content1.xCenter));
                        Debug.WriteLine("y {0}", huskylens.readeBox(1, Content1.yCenter));
                        Debug.WriteLine("k {0}", huskylens.readeBox(1, Content1.width));
                        Debug.WriteLine("h {0}", huskylens.readeBox(1, Content1.height));
                    }
                    else
                    {
                        Debug.WriteLine("-1");
